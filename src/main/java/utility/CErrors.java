    ...
    public void checkWSErrors(VData v) {
        ...
        if (type.equals(CError.TYPE_NONE)) {
            ...
            if (type.equals(CError.TYPE_ALLOW)) {
                content = "保存成功，但是：" + (String) v.get(1);
                flag = "Success";
            } else {
                content = "保存失败，原因是：" + (String) v.get(1);
                flag = "Fail";
            }
        }
    }
...
//        System.out.println(te1.getErrorCount());
//        System.out.println(te1.getFirstError());
//        System.out.println(te1.needDealError());
//        if (te1.needDealError())
//        {
//            System.out.println("Need Error");
//        }
//        else
//        {
//            System.out.println("Not Need Error");
//        }
    }
